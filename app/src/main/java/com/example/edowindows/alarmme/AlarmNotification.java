...
public class AlarmNotification extends Activity implements
        TextToSpeech.OnInitListener
{
  ...
  private void addNotification(Alarm alarm)
  {
    ...
    notification = builder
        ...
        .setSmallIcon(R.drawable.falertuicon)
        .setAutoCancel(true)
        .setContentTitle("Missed alert: " + alarm.getTitle())
  ...
  private void speakOut() {
    ...
    tts.speak(mAlarm.getTitle(), TextToSpeech.QUEUE_FLUSH, null);
  }
